...
const NavigationDesktop = () => {
  ...
  return (
    ...
    >
      ...
      { config.chain.networkType === 'stagenet' ? <Icon as={ testnetIcon } h="14px" w="auto" color="red.400" position="absolute" pl={ 3 } top="34px"/> : <Icon as={ stagenetIcon } h="14px" w="auto" color="red.400" position="absolute" pl={ 3 } top="34px"/> }
      <Box
        as="header"
        display="flex"
